...
# Developed and deployed an AI-driven healthcare prediction system using Logistic Regression (Scikit-learn, 
Python) to analyze medical test parameters; applied data preprocessing, feature engineering, and model 
evaluation; deployed as a real-time web application using Streamlit achieving 85%+ model accuracy. 
